...
<html>
<head>
<title>Motive Mag a Entertainment Category Flat Bootstrap Responsive Website Template | Entertainment :: w3layouts</title>
					 ...
					 <div class="technology">
			              ...
			              <h3 class="tittle"><i class="glyphicon glyphicon-file"></i>
						    ...
						    <div class="business-inner">
						    	...
						    	<?php foreach ($query->tampil_kategori($title) as $row) {
								    	$waktu   =$row['date'];
										$date    =explode('-', $waktu);
										$tahun   =$date[0];
										$bulan   =$date[1];
							  ...
							  <!--  ================================ PLAYER VIDEO
							      <iframe src="https://player.vimeo.com/video/47637849?color=db092f&amp;byline=0&amp;portrait=0"></iframe>

 -->							  <img src="master/root/<?php echo $row['photo'];?>" width="100%">	
 								  <a href="single.php?id=<?php echo $row['id_berita'];?>" class="ma"><?php echo $row['judul'];?></a>
								  <p><?php echo substr($row['berita'],0,150);?></p>
								  <a><?php echo $tanggal.'/'.$bulan.'/'.$tahun;?></a>
								  <p></p><p></p>
							  </div>
